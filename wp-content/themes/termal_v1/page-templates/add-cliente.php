<?php /* Template Name: Agregar Cliente */ ?>
                ...
                <div class="row">
                    <div class="col s12 m12 l12">
                        <div class="card menu white">
                            <form id="formAddCliente" name="formAddCliente">
                                ...
                                <div class="input-field col s6">
                                    ...
                                    <input placeholder="Fecha de vencimiento" id="fecha_vencimiento" name="fecha_vencimiento" type="date" class="validate" value="<?php echo $fechaActual; ?>">
                                    <label for="fecha_vencimiento">Fecha de vencimiento</label>
                                </div>
                                <div class="cta right">
                                    <input type="submit" id="btnAddCliente" name="btnAddCliente" class="btn" value="Guardar" />
