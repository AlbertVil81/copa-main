            ...
            <div class="col s12 m12 l10 p-right">
                ...
                <div class="row stickySearch">
                    <div class="input-field col s12 l9">
                        ...
                        <label for="searchAlumnos">Buscar alumno</label>
                ...
                <div class="flexing">
                    ...
                    <div class="add">
                        <br>
                        <a href="<?php bloginfo("url"); ?>/dashboard/agregar-alumno/"><p>Alta de alumno <i class="material-icons">add_circle</i></p></a>
                    </div>
                </div>
                <div class="row">
