<?php /* Template Name: Agregar Curso */ ?>
        ...
        <div class="row dashboard__alumnos">
            ...
            <div class="col s12 m12 l10 p-right">
                ...
                <div class="flexing">
                    ...
                    <div class="add">
                        <br>
                        <p><b>Agregar Curso</b></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col s12 m12 l12">
                        <div class="card menu white">
                            <form id="formAddCurso" name="formAddCurso">
                                <div class="input-field col s6">
                                    <input placeholder="Nombre" id="nombre" name="nombre" type="text" class="validate">
                                    <label for="nombre">Nombre</label>
                                </div>
                                <div class="input-field col s6">
                                    <input placeholder="Nota" id="nota" name="nota" type="text" class="validate">
                                ...
                                <div class="cta right">
                                    <input type="submit" id="btnAddCurso" name="btnAddCurso" class="btn" value="Guardar" />
