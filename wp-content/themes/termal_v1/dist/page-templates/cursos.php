            ...
            <div class="col s12 m12 l10 p-right">
                ...
                <div class="row stickySearch">
                    <div class="input-field col s12 l9">
                        ...
                        <label for="searchCursos">Buscar curso</label>
                ...
                <div class="flexing">
                    ...
                    <div class="add">
                        <br>
                        <a href="<?php bloginfo("url"); ?>/dashboard/agregar-curso/"><p>Agregar curso <i class="material-icons">add_circle</i></p></a>
                    </div>
                </div>
                <div class="row">
                                        ...
                                        <tbody>
                                            <?php foreach($cursos as $curso){ ?>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <a href="<?php bloginfo("url"); ?>/dashboard/detalles-curso/?id=<?php echo $curso['ID']; ?>"><i class="material-icons">info</i></a>
                                                        <a href="<?php bloginfo("url"); ?>/dashboard/grupo/?id=<?php echo $curso['ID']; ?>"><i class="material-icons">group</i></a>
                                                    </th>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
